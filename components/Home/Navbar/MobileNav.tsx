    ...
    <div>
      ...
      >
        ...
        <button
          ...
          className="text-white w-fit text-xl ml-12 border-b-[1.5px] pb-1 border-white sm:text-[30px] flex items-center gap-2 hover:text-cyan-300 transition-all duration-200"
        >
